...
function obtenerEstadoInventario() {
    fetch('https://transmicorp02.pythonanywhere.com/inventario/obtener_estado_inventario')
...
function verificarFacturasPendientes() {
    fetch('https://transmicorp02.pythonanywhere.com/facturas/verificar_facturas_pendientes')
        .then(response => response.json())
        .then(data => {
